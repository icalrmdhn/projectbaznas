    ...
    <div class="flex flex-col mt-6 w-full">
        @if (Auth::user()->level == 0 && request()->has('filter'))
            ...
            @elseif (request('filter') == 'total_ttd_sudah')
                <h1 class="text-3xl font-bold text-center">Data Mustahik Sudah TTD</h1>
            @elseif (request('filter') == 'total_ttd_belum')
                <h1 class="text-3xl font-bold text-center">Data Mustahik Belum TTD</h1>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto" id="tabel_nasabah">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100 cursor-pointer">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <p class="text-sm font-normal text-center text-black">{{ $item->signed_koordinator ? "Sudah Tanda Tangan" : "Belum Tanda Tangan" }}</p>
                                </td>
                                @endif
