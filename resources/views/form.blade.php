        ...
        <section id="identifikasi_scoring" class="my-4 space-y-4 analisis">
          ...
          <div class="flex gap-12 justify-between">
            ...
            <div class="">
              ...
              <div class="flex gap-2">
                <button type="button" id="rekomendasi_ya" class="px-4 py-6 w-28 bg-gray-50 text-black rounded-lg border border-gray-300">Ya</button>
                <button type="button" id="rekomendasi_tidak" class="px-4 py-6 w-28 bg-gray-50 text-black rounded-lg border border-gray-300">Tidak</button>
