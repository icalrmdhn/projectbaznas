                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto" id="tabel_pengguna">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-100 cursor-pointer">
                                ...
                                <td class="px-4 py-4 whitespace-nowrap">
                                    <p class="text-sm font-normal text-center text-black">{{ $user->koordinator_name ? $user->koordinator_name : 'Bukan Surveyor' }}</p>
                                </td>
                                <td class="px-2 py-4 whitespace-nowrap items-center justify-center align-middle flex">
                                  ...
                                  <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown-{{$user->id}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"> Action <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="https://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                  ...
                                  <div id="dropdown-{{$user->id}}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                      ...
                                      <li>
                                      <a href="{{ route('user-edit', $user->id) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 ">Edit</a>
                                      </li>
                                      <li>
                                          <form action="{{ route('user-destroy', $user->id) }}" method="POST" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 ">
                                              @csrf
                                              @method('DELETE')
